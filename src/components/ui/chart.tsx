...
type TooltipValue = PrimitiveValue | readonly PrimitiveValue[];

type TooltipPayloadEntry = {
  name?: PrimitiveValue;
  value?: TooltipValue;
  dataKey?: PrimitiveValue;
  color?: string;
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item, index) => {
           ...
           const normalizedValue: PrimitiveValue | undefined =
    ...
    return (
      ...
      >
        {payload.map((item, index) => {
          ...
          return (
            <div
              key={`${String(item.value ?? item.dataKey ?? index)}-${index}`}
              className={cn(
